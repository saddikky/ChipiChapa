...
<body>
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link active fs-4" href="{{route('employee.add')}}">Add Employee</a>
            </li>
            <li class="nav-item">
        </ul>
        ...
        <div class="container rounded-3 bg-dark" style="margin-top: 100px; width: 50%; margin: 25px auto; padding: 20px;">
            <div class="row justify-content-center">
                ...
                <form class="bg-dark text-light p-3">
                    ...
                    <input type="number" name="age" min="21" placeholder="age" class="form-control" style="width:100%">
                    </div>

                    <div class="form-group mb-4">
                    <label class="form-label text-info">Address</label>
                    <input type="text" name="address" placeholder="address" class="form-control" style="width:100%">
                    </div>

                    <div class="form-group mb-4">
                    <label class="form-label text-info">Phone Number</label>
                    <input type="text" name="phone" placeholder="phone number" class="form-control" style="width:100%">
                    </div>

                    <div class="form-group d-flex justify-content-end">
                <button type="submit" class="btn btn-danger">Add Employee to Database</button>
        </div>
      </form>
    </div>
  </div>
